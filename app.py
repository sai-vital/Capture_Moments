...
photographers = [
    ...
    {"id": "p3", "name": "Richard", "skills": ["Editing", "Creativity"], "image": "ram.jpg"},
    {"id": "p4", "name": "Henri cateria", "skills": ["Designing", "Technical skills"], "image": "harika.jpg"}
]

# Step 3: Dummy availability data mapped by photographer IDs
availability_data = {
    "p1": ["2025-06-20", "2025-06-23"],
    "p2": ["2025-06-19", "2025-06-22"],
    "p3":["2025-08-25","2025-11-30"]
}
#Home Page
@app.route('/')
def home():
